...
import { DocumentFileNodeData } from './DocumentFileNode'
...
defineProps<NodeProps<DocumentFileNodeData>>()
...
<template>
  ...
  >
    <!-- <Handle
      ...
      class="!bg-muted-foreground transition-colors duration-300"
    /> -->
    ...
    <div class="flex items-start gap-5">
      ...
      <div class="space-y-2">
        ...
        <div class="flex items-center text-xs text-muted-foreground/75">
          ...
          <span class="italic">{{ formatDistanceToNow(data.updatedAt, { addSuffix: true }) }}</span>
        </div>
      </div>
    </div>
